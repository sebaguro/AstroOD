...
Some case-study 'events' are identified. Metrics of Open Development should be established but could be determined over time by the community. Some risk factors at World, National, Provincial, State and University levels of governance are examined. Some have led to astronomical communities failing to enter or even maintain international collaborations on global projects, or led to a so-called 'global' brain drain flight of Astronomy Majors to other industries, caused interruption of unique telescope facilities from normal operations or delayed construction. 

Our model, identifies the following actors that are part of an already burgeoning "Open Source" Community: Astropy, National Public Universities and other astronomical institutions as recognized by datafeeds from the existing protocols: eg; google-scholar; NASA-ADS;  whose weighting as proposed should be configurable, and managed via WEB3 enabled DAPPs, by the community. Some international entities identified as potentially necessary founding members include; The  International Virtual Observatory Alliance and the International Astronomical Union. These entities could be delegated votes from individuals in governance poll.

In a AstroOP model, founding members to bootstrap AstroOD could include Decentralized Exchange(s) eg: UNISWAP, and other Decentralized organizations to be considered: The case is made that AstroOD be funded by DEFI, including UNISWAP Treasury and Education funds, \href{gitcoin grants} {https://gitcoin.co/grants/}, etc.,.  Some case-studies identified include an NFT series to celebrate the 150 year anniversary of the former Argentine National Astronomical Observatory of the 1912 Solar Eclipse expedition by the Director of the Argentine National Observatory by Perrine 1912, with a message signed by Honorary IAU member and historian Santiago Paolantonio or NFT fund prizes and unlocks,  for the Institute of Theoretical and Experimental Astronomy's (IATE) Friends-of-Friends Annual Meeting. 
