...
Cryptography, the basis of OB ledger technology or distributed ledger technology (DLT), has until now not been much considered for astronomy development, as revealed in 'full-text' searches of astronomical peer-reviewed international journal papers, least as a potential interoperability catalysing agent. In fact, cryptography for Astronomy has its main use as an ancillary technology within data transfer applications like data compression, permission, (eg: ssh-rsa) and other data fidelity procedures (eg: checksum) for software development.
