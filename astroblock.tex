...
The Kardashev astrophysical law is one of energy consumption or power versus time for radio-capable civilizations. We take global human Power production data from 1964 to 2022 and compare it to two Kardashev models. The standard Kardashev one-percent monotonically increasing model that is approximately exponential and, a linear model that is the OLS fit to the data. The two competing models have significant different mathematical and statistical properties. The OLS linear model has a slope and intercept of $5.78 \pm 0.09$ TW per day and $-1.40  \pm 0.02 \times 10^{7} $ TW respectively, with the data showing low dispersion about the fit while the approximately exponential model diverges from the data. The dimensional variables of power and time have time covariance and obviously must be further restricted; nothwithstanding this: against The Julian day as herein justified we show the linear model with its low dispersion across nearly two orders of magnitude in time that transcends several technological and political eras of modern energy production from coal, oil, nuclear to renuables (hydro, wind, geothermal, solar etc.) appears to be more consistent with the maximal likelihood function of the Kardashev law. The OLS model fit is not constrained by the \textbf{memoryless} probability property implicit in constant percentage increase models that preclude negative year-over-year growth critically underestimating the lapse of time required for a typical nascent radio capable civilization to evolve to a Kard$\,_{\textrm{type-ii}}$ on the original scale in consuming as much energy per second as produced by a typical dwarf main sequence star, like The Sun. In leu of this prediction that the original Kardashev scale does not appear tenable and to resolve a shortcoming of the linear model prediction: that radio-nascent civilizations of the Human Kind would typically require more than a Hubble time to evolve to Kard$\,_{\textrm{type-ii}}$; is that we consider the Kardashev-Nakamoto model by selecting the Kardashev OLS linear model fit and re-normalizing the Power Production metric (J/s) by the Scalar Bitcoin Hash-Rate function year average (in Hash/s). The equivalence unit of J/Hash that results satisfies an implicit requirement of the original Kardashev law of the inclusion of information-richness without additional parameters. The Bitcoin hash-rate is not a monotonically increasing function, since the two-week difficulty adjustment prohibits monotonic growth, and so represents a more universal approximation of the law. We speculate on a prediction: if the Kardashev-Nakamoto model reflects physical reality, its impact on both the uncertain Drake equation longevity term for 'advanced' civilizations, and the evolution of the Doomsday clock must also be reconsidered. The new Kardashev-Nakamoto straw-person model provides a somewhat theoretical basis of an interoperability development driver for Astronomy \& Astrophysics; Education, Research and Development, based on Public Open Blockchain Ledger technology. A caveat to this analysis: the Power metric used is not "total global yearly average Energy consumed, in one hour" but "total global yearly average Energy produced, in one hour"; so for our purpose, production is taken as an upper limit proxy to consumption for which we base our model. 
...
\label{sec:intro}
%
 The Antikythera mechanism was found in 1901 from the debris of a ship-wreck that was estimated to have occurred about two thousand years earlier. Computer \& Data Scientists on average recognize it to be the first analogue computer mechanism or simply put: The Computer.\\ \citet{Freeth2021} and other studies therein have demonstrated that the Antikythera mechanism was designed to solve mostly astronomical problems based on a technology that rested on much support from ancient Greek Astronomers, including Hipparchus and Archimedes. The detailed scanning and modelling of the recovered 'jig-saw puzzle' relic by \citet{Freeth2021} reveal that the mechanism is over 2000 years old and contains at-least three finely crafted rotating discs and more than thirty-odd cogs that were designed, forged, and crafted with adequate tolerances to calculate and predict the positions of astronomical sources including The Sun; The Moon; and some planets across space and time; calculations necessary for navigation, agriculture, cultural and scientific/technological reckonings, here assumed to have been at the bequest of open human development and the Julian Day Calender system set for the epoch when the 28-year Solar, 19-year Metonic and 15 year Roman Indiction or tax Cycles resulted in a conjunction, of sorts.
...
\begin{table}[h]
\centering
\caption{Your 1st Table Caption}
\label{kard_comp}
