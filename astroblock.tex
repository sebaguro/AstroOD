...
\begin{abstract}
This white paper explores open-source public blockchain (OB) ledger technology as a necessary agent for value optimisation and interoperability in Open Astronomy Development (OAD). We provide a review of the evolution of blockchain protocols, emphasising the key ideas and primitives leading to the Nakamoto consensus and its role in addressing the Byzantine Generals Problem, setting the stage for a universal system-of-value model as an astrophysical consequence.

Central to this paper is the connection of OB technology to the evolution of astrophysical discoveries and data science systems that co-evolve. This exploration posits OB technology as a nascent, yet potentially disruptive, cornerstone technology for the decentralized development of astronomy and beyond.

Our model begins with the Kardashev conjecture, which in its original form relates civilisation technological prowess to energy consumption. It is one that assumes a fixed percentage of total civilisation energy consumption for radio transmission and reception for extra-terrestrial communication. We show empirically and theoretically that the standard Kardashev model is untenable and demonstrate its flaw by analysing the temporal evolution of the total global produced power for The Earth and the nature of its underlying theoretical distribution. A competing model is proposed to resolve the conundrum based on a simple re-normalization of the total global produced power by the Bitcoin hash rate as an innovative yardstick that we speculate may be more closely related to a universal cosmological constant, than does the original Kardasehv relation. This approach is consistent with the intent of the original Kardashev model (and scale) to simultaneously include a measure the security of a vast quantity of information that must be sensitive to the civilisation's technological prowess. 

The paper shows this result through simple model comparisons and concludes with an examination of the energy debate surrounding Bitcoin and its implications as a technological tool for liquidity pool management and governance in OAD. We discuss the future application prospects of blockchain technology in advancing astronomical research and development, highlighting its potential to drive innovation through universal protocols that preserve information richness.
...
\end{figure}
 ...
 The ancient Greek astronomers had defined the logarithmic magnitude system and introduced concepts of limits and infinitesimals that would become the basis of differential geometry, calculus and numerical methods; they had also paved the way for The Romans to define the Julian Day to count time, defining epochs, using the 28-year Solar, 19-year Metonic and 15-year Roman Indiction or tax Cycles that resulted in a conjunction of sorts. Many of these advances are readily found today in open source toolkits or libraries for the development of astronomy, built by community efforts; eg Scipy, Astropy, IVOA. 
